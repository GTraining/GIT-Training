 ...
 */
public class RealmBaseActivity extends DemoBase {
    ...
    protected void setup(Chart<?> chart) {
        ...
        if (chart instanceof BarLineChartBase) {
            ...
            leftAxis.setValueFormatter(new PercentFormatterCustom());
    ...
    protected void styleData(ChartData data) {
        ...
        data.setValueFormatter(new PercentFormatterCustom());
    }

    public class PercentFormatterCustom extends PercentFormatter{
        protected DecimalFormat mFormat;

        public PercentFormatterCustom() {
