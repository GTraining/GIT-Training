...
public class CustomizeLinearLayout extends LinearLayout {
    public CustomizeLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (listener != null) {
            listener.onSoftKeyboardShown(diff > 100); // assume all soft keyboards are at least 128 pixels high
        }
